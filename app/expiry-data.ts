...
export const expiryItems: ExpiryItem[] = [
  ...
  { id: 'blue-cheese-melted', name: 'Соус плавленый «Блю Чиз»', group: 'Сыры', openedHours: 72, openedRule: 'Не более 72 часов', condition: 'В пределах общего срока годности' },
  { id: 'blue-cheese-sauce', name: 'Сырный соус «Блючиз»', group: 'Соусы', openedHours: 72, openedRule: 'Не более 72 часов', condition: 'В пределах общего срока годности' },
  { id: 'hash-browns', name: 'Хэшбрауны картофельные', group: 'Овощи', openedHours: 168, openedRule: '7 суток', condition: 'Не выше −18 °C, в пределах общего срока годности' },
  { id: 'tabasco', name: 'Соус табаско', group: 'Соусы', openedHours: 2160, openedRule: 'Не более 90 суток', condition: 'В пределах общего срока годности' },
  { id: 'lemonade-strawberry-mojito', name: 'Основа «Клубничный мохито»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'lemonade-mango-passionfruit', name: 'Основа «Манго-маракуйя»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'lemonade-grapefruit-elderberry', name: 'Основа «Грейпфрут-бузина»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'lemonade-raspberry-aloe', name: 'Основа для лимонада «Малина-алоэ»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'lemonade-plum-spices', name: 'Основа для лимонада «Слива с пряностями»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'syrup-strawberry-ice-cream', name: 'Сироп «Клубничный пломбир»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'syrup-orange-spritz', name: 'Сироп «Апельсиновый спритц»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'syrup-vanilla', name: 'Сироп ванильный', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'syrup-hazelnut', name: 'Сироп «Лесной орех»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'syrup-peanut-crunch', name: 'Сироп «Арахисовый кранч»', group: 'Напитки', openedHours: 2160, openedRule: 'Не более 3 месяцев', condition: 'При соблюдении условий хранения и в пределах общего срока годности' },
  { id: 'cheddar-sliced', name: 'Сыр чеддер слайсовый', group: 'Сыры', openedHours: 72, openedRule: '72 часа', condition: '+1…+6 °C во вскрытой плотно закрытой упаковке; в пределах общего срока годности' },
  { id: 'chicken-schnitzel', name: 'Шницель куриный', group: 'Птица', labelMode: 'opening-only', condition: 'После вскрытия действует общий срок годности по заводской маркировке' },
];
...
export const expiryQuestions = [
  ...
  { id: 11, text: 'На шницеле курином нет отдельного срока после вскрытия. Какую этикетку печатают?', options: ['Только дату и время открытия', 'Дату открытия и 24 часа списания', 'Дату дефростации и 72 часа списания', 'Этикетку не печатают'], correct: 0, note: 'Если отдельного срока после вскрытия нет, печатают только дату открытия и сверяют общий срок годности по заводской маркировке.' },
  { id: 12, text: 'Какой срок после вскрытия у картофельных хэшбраунов при хранении не выше −18 °C?', options: ['48 часов', '72 часа', '7 суток', '30 суток'], correct: 2, note: 'Картофельные хэшбрауны после вскрытия хранят 7 суток при температуре не выше −18 °C и в пределах общего срока годности.' },
  { id: 13, text: 'Какой срок после вскрытия у лимонадной основы «Манго-маракуйя»?', options: ['7 суток', '30 суток', '2 месяца', '3 месяца'], correct: 3, note: 'Лимонадную основу после вскрытия хранят не более 3 месяцев при соблюдении условий хранения и в пределах общего срока годности.' },
  { id: 14, text: 'Какой срок после вскрытия у слайсового чеддера при +1…+6 °C?', options: ['24 часа', '48 часов', '72 часа', '7 суток'], correct: 2, note: 'Слайсовый чеддер после вскрытия хранится 72 часа во вскрытой плотно закрытой упаковке при +1…+6 °C.' },
  { id: 15, text: 'Что делать, если на маркировке указано: «после вскрытия продукт хранению не подлежит»?', options: ['Использовать сразу и не оставлять на хранение', 'Напечатать срок 12 часов', 'Хранить до следующей смены', 'Поставить только дату открытия'], correct: 0, note: 'Такой продукт используют сразу после вскрытия. Самостоятельно назначать срок хранения нельзя.' },
];
