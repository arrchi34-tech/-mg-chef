...
export const expiryItems: ExpiryItem[] = [
  ...
  { id: 'fries', name: 'Картофель фри', group: 'Овощи', defrostHours: 48, openedHours: 48, defrostRule: '2 суток', openedRule: '2 суток', condition: 'По условиям поставщика' },
...
export const expiryQuestions = [
  ...
  { id: 4, text: 'Какой срок после дефростации у картофеля фри?', options: ['12 часов', '24 часа', '48 часов', '7 суток'], correct: 2, note: 'После дефростации картофель фри хранится 2 суток — 48 часов.' },
